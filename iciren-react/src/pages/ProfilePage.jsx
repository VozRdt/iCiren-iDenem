            ...
            <div className="profile-card-wrapper">
              <div className="profile-card">
                ...
                <div className="wallet-card">
                  <p className="wallet-label">Saldo Penghasilan</p>
                  <h3 className="wallet-balance">Rp {(profile.total_earnings || 0).toLocaleString('id-ID')}</h3>
                  <button className="btn btn-primary" style={{ width: '100%', padding: '0.8rem' }}><i className="fas fa-money-check-alt"></i> Tarik Tunai</button>
                </div>
              </div>
            </div>
